...
const usuariosDestino = computed(() => {
  ...
  if (!q) return usuariosRecentes.value
  return usuariosRecentes.value.filter(u =>
...
<template>
  ...
  <div class="min-h-dvh bg-[#0b0d12] text-white flex flex-col">

    <!-- ── HEADER ── -->
    <header class="bg-[#0b0d12]/95 backdrop-blur-xl border-b border-white/5 px-4 h-14 flex items-center justify-between sticky top-0 z-40 lg:pl-72">
    ...
    <!-- ── MAIN CONTENT ── -->
    <main class="flex-1 w-full max-w-3xl mx-auto px-3 pt-5 pb-28 lg:max-w-none lg:ml-64 lg:px-8 lg:pb-8">
